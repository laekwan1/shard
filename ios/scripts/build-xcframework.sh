...
cargo rustc -p shard-mobile --release --features resign --target aarch64-apple-ios --crate-type staticlib
cargo rustc -p shard-mobile --release --features resign --target aarch64-apple-ios-sim --crate-type staticlib
